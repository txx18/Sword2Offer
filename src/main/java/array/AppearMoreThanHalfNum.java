 ...
 * TODO solutionArrayProperty 可扩展 在数组中找到出现次数大于N/K的数
...
public class AppearMoreThanHalfNum {
    ...
    public static void main(String[] args) {
        ...
        AppearMoreThanHalfNum obj = new AppearMoreThanHalfNum();
        int res = obj.solutionBoyerMooreMajorityVoteAlgorithm(arr1);

        System.out.println("res = " + res);
    }

    public int solutionBoyerMooreMajorityVoteAlgorithm(int[] nums) {
        int majority = nums[0];
        int count = 0; // = 0 或 = 1 都行
        ...
        return majorityCount > nums.length / 2 ? majority : 0;
    }
